#ifndef A1_MAZE_1_SRC_MAZE_CAVES_VIEW_OPENGL_WIDGET_GL_OVERRIDE_H_
#define A1_MAZE_1_SRC_MAZE_CAVES_VIEW_OPENGL_WIDGET_GL_OVERRIDE_H_
...
#endif  // A1_MAZE_1_SRC_MAZE_CAVES_VIEW_OPENGL_WIDGET_GL_OVERRIDE_H_
